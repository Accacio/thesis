...
Furthermore, in this chapter, we assume that for all sub-systems, their unconstrained solutions $\vec{U}_{i_{\text{unc}}}^{\star}[k]$ neither respect the local constraints, that means,
\begin{equation}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=7cm]{../img/original-minimum.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=7cm]{../img/new-minimum-selfish.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=7cm]{../img/ignoreX.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=7cm]{../img/correctX.png}
...
\note{If time permits I can add here a discussion about the error on reconstructing lambda from estimation error}
...
The attack\todo{s} chosen for scenarios~\ref{it:case_selfish} \todo{and~\ref{it:case_selfish_recovered},
are}
\begin{align}
  T_{I}=\begin{cases}
          \todo{4I_{\card{\lambdai}}\text{, if }k< 4}\\
          I_{\card{\lambdai}}\text{, otherwise}
        \end{cases}\\
  T_{IV}=\begin{cases}
          \todo{4I_{\card{\lambdai}}\text{, if }k< 6}\\
          I_{\card{\lambdai}}\text{, otherwise}
        \end{cases}
\end{align}
.
...
\caption{Temperature in house I and the decision variable $E_{I}(k)$ for different scenarios. \todo{remake figure}}\label{fig:response_houseI_3Scenarios}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=7cm]{AirTempAndDecisionVariable.pdf}
\caption{Temperature of houses II to IV, and respective references for different scenarios. \todo{remake figure}}\label{fig:response_housesII_to_IV_3Scenarios}
\end{figure}
...
\begin{table}[h]
  ...
  \begin{tabular}[t]{cccc}
    ...
    \midrule
    \input{../data/eq_table_costs_all_rooms_error.tex}\\
    \bottomrule
  \end{tabular}
\end{table}
