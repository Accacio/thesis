...
% \begin{equation}
% \tilde{\lambdai}\pplusone=T_{i}[k]\left(-P_{i}\left(\thetai\p+\rho\p\left(\tilde{\vec{\lambda}}_{i}\p-\frac{1}{M}\sum_{j=1}^{M}\tilde{\vec{\lambda}}_{j}\p\right)\right)-\vec{s}_{i}[k]\right).
% \end{equation}
% \begin{equation}
%   \label{eq:lambda_dynamics_with_P_and_s}
% \tilde{\lambdai}\pplusone=-T_{i}[k]P_{i}\rho\p\tilde{\vec{\lambda}}_{i}\p+T_{i}[k]P_{i}\rho\p\frac{1}{M}\sum_{j=1}^{M}\tilde{\vec{\lambda}}_j\p+T_{i}[k]\left(-P_{i}\thetai\p-\vec{s}_{i}[k]\right).
% \end{equation}
\begin{equation}
