...
As argued in~\cite{CardenasEtAl2008}, to accomplish attacks A13 the attacker needs physical access to the plant. So an attacker would prefer to commit attacks A1-A12, since the attacker has less risk to be identified and not necessarily needs to by physically close to the plant, reducing also risk for injuries. As we will see in a future section, this kind of attacks can be easily prevented.
