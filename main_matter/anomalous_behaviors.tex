...
This part is called the \textbf{Detection/Isolation} phase, where the attack can be detected throught the monitors and the mishaving component/agent can be isolated.
...
\subsubsection{Detection/Isolation}
