...
\begin{figure}
  ...
  \begin{tikzpicture}[circuit ee IEC,
    ...
    \node[red,right=1cm of info_in,inner sep=1pt,align=center] (a3) {\scalebox{1.5}{\faUserSecret}};
    \draw[-latex,thick] (a3) -- (info_in) node [midway,below,sloped] {A3};

    \node[red,left=1cm of info_out,inner sep=1pt,align=center] (a5) {\scalebox{1.5}{\faUserSecret}};
    \draw[-latex,thick] (a5) -- (info_out) node [midway,below,sloped] {A5};


    \node[red,below left=1cm of a,inner sep=1pt,align=center] (a7) {\scalebox{1.5}{\faUserSecret}};
    \draw[-latex,thick] (a7) -- (input) node [midway,below,sloped] {A7};


    \node[red,right=.4cm of switch_output,inner sep=1pt,align=center] (a2) {\scalebox{1.5}{\faUserSecret}};
    \node[red,inner sep=1pt,align=center] at ($(switch_output) + (.3,0)$) {\rotatebox[origin=c]{180}{\faCut}};
    \node [above,sloped] at ($(a2) + (-.05,-.8)$) {A2};

    \node[red,right=.4cm of nin2,inner sep=1pt,align=center] (a4) {\scalebox{1.5}{\faUserSecret}};
    \node[red,inner sep=1pt,align=center] at ($(nin2) + (.3,0)$) {\rotatebox[origin=c]{180}{\faCut}};
    \node [above,sloped] at ($(a4) + (-.05,-.8)$) {A4};


    \node[red,left=.4cm of nout2,inner sep=1pt,align=center] (a6) {\scalebox{1.5}{\faUserSecret}};
