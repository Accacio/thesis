...
In the \dmpc{} community, as pointed in~\cite{ArauzEtAl2021}, the cyber-physical security has not been sufficiently studied. While many decompositions methods are created, usually the agents are considered cooperative and no vulnerabilities not explored.

Some recent works began to explore the vulnerabilities of some decompositions methods,
such as dual decomposition.

~\cite{DibajiIshii2015,WangIshii2019,VelardeEtAl2018}
s{} use as base
...
\todo{Other kind of detectors can be found in~\cite{ZhangEtAl2021a}}
