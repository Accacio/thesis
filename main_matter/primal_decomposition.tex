...
\begin{equation}
  \label{eq:1}
  \begin{array}{ccc}
H_1=\left(\begin{array}{cc} 1.9446 & 0.4608\\ 0.4608 & 1.5760 \end{array}\right) & \vec{f}_1[k]=\left(\begin{array}{c} -5.5182\\ -3.6313 \end{array}\right) & \bar{\Gamma}_1=\left(\begin{array}{cc} 1 & 0\\ 0 & 1 \end{array}\right)\\
H_2=\left(\begin{array}{cc} 2.2240 & 0.5400\\ 0.5400 & 1.9000 \end{array}\right) & \vec{f}_2[k]=\left(\begin{array}{c} -5.7717\\ -4.4875 \end{array}\right) & \bar{\Gamma}_2=\left(\begin{array}{cc} 1 & 0\\ 0 & 1 \end{array}\right)\\
H_3=\left(\begin{array}{cc} 1.6682 & 0.2304\\ 0.2304 & 1.5760 \end{array}\right) & \vec{f}_3[k]=\left(\begin{array}{c} -2.7687\\ -2.2582 \end{array}\right) & \bar{\Gamma}_3=\left(\begin{array}{cc} 1 & 0\\ 0 & 1 \end{array}\right)\\
  \end{array}
\end{equation}
