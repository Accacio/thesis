...
\begin{equation}
\label{eq:primalDecomposition}
 \thetai\pplusone=\thetai\p+\rho\p\left(\lambdai\p-\frac{1}{M}\sum_{j=1}^{M}\lambda_j^p\right),\forall i\in\set{M}
\end{equation}
