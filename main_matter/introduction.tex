...
\todo{Things to say here:
  \begin{itemize}
    ...
    \item Security problems in those systems \\Here I can give some examples such as Stuxnet \cite{Langner2011}, Brazil blackouts in 2010 \cite{Conti2010} and other attacks (use examples in~\cite{DingEtAl2018,Bindra2017})%
  \end{itemize}
