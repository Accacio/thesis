...
In \textbf{this work}, we choose to use a \textbf{hierarchical} structure, described later (\S \todo[put section]{??}).
...
\todo{In \textbf{this work} we suppose nodes communicate bidirectionally and synchronously.}
