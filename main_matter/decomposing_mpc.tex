...
Although the solution of such problems can be straightforward, since solvers are widely known and the problem is well structured, in this \textbf{monolithic} form these problems can be computationally intensive depending on the sizes of $n_{x}$, $n_{u}$ and $N$.
