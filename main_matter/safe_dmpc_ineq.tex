...
\section{Complete safe dMPC}\label{sec:complete-safe-dmpc-ineq}
Putting together all parts defined in the last sections, we can come up with Algorithm~\ref{alg:safeDMPC}, which resumes the \rpdmpc{} when the unconstraint solution is on the decomposable constraint set.
...
\begin{algorithm2e}[h]
 ...
 \caption{Resilient Primal Decomposition-based dMPC. \todo{rework algo}}\label{alg:safeDMPC}
\end{algorithm2e}
