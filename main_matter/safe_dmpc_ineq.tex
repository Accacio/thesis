...
We begin by the end, with the proposal for the mitigation because the proposal follows a straightforward logic and impacts the proposal for the detection, simplifying the solution.
...
Therefore, we need an estimation method which can also classify simultaneously the points, indicating to which zone they correspond.
Then, we take only the parameters which interest us, that is $\Plinineq$.
...
However, since we are going to use $\Plinineqtildeestimate$ for the mitigation part, we also use it for the detection.
