...
\begin{remark}
  Although the problem has guaranteed convergence, as in other methods, it is not for a global maximum.
  The possible local maxima found depend on the initialization of the estimates in $\set{P}$~\cite{Bishop2006,BaudryCeleux2015,GepperthPfuelb2021}.
  Some studies comparing the \EM{} with other variants such \sEM{} and \CEM{} exist~\cite{FariaSoromenho2010}.
  The choice of initial steps is not in the scope of this work.
\end{remark}
