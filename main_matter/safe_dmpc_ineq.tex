...
\begin{equation}
  \lambdaicheat[k]=
  \begin{cases}
    -\widetilde{\Plinineq      }\thetaik-\widetilde{\sikineq      },&\text{if }\thetaik\in\set{R}^{0}\\
    -\widetilde{\Plinineq[i][1]}\thetaik-\widetilde{\sikineq[i][1]},&\text{if }\thetaik\in\set{R}^{1}\\
    -\widetilde{\Plinineq[i][2]}\thetaik-\widetilde{\sikineq[i][2]},&\text{if }\thetaik\in\set{R}^{2}\\
    -\widetilde{\Plinineq[i][3]}\thetaik-\widetilde{\sikineq[i][3]},&\text{if }\thetaik\in\set{R}^{3}\\
...
\begin{align}
  ...
  \frac{1}{M}\left(\sum_{j\in\set{M}}\vec{\theta}_{j}\p-\vec{U}_{\max}\right)&
                                                                     + \rho\p\left(
                                                                     -\widetilde{\Plinineq[i][n(i)]}\thetai\p-\widetilde{\sikineq[i][n(i)]}
                                                                     \right) \notag\\
                                                                   &-\frac{\rho\p}{M}\sum_{j\in\set{M}}\left(
                                                                     -\widetilde{\Plinineq[j][n(j)]}\vec{\theta}_{j}\p-\widetilde{\sikineq[j][n(j)]}
                                                                     \right)
\end{align}
...
\begin{align}
  \thetai\pplusone=\thetai\p+\rho\p\left(-\widetilde{\Plinineq[i][n(i)]}\thetai\p+\frac{1}{M}\sum_{j\in\set{M}}\widetilde{\Plinineq[j][n(j)]}\vec{\theta}_{j}\p\right)+\frac{1}{M}\left(\sum_{j\in\set{M}}\vec{\theta}_{j}\p\right)\\+\rho\p\left(-\sik+\frac{1}{M}\sum_{j\in\set{M}}\vec{s}_{j}[k]\right) -\frac{\vec{U}_{\max}}{M}
\end{align}
resulting in
\begin{equation}
...
\begin{matrix}
2I-\frac{1}{2}\rho\p \widetilde{\Plinineq[I][1]} & I+\frac{1}{2}\rho\p \widetilde{\Plinineq[II][2]}\\
I+\frac{1}{2}\rho\p \widetilde{\Plinineq[I][1]} & 2I-\frac{1}{2}\rho\p \widetilde{\Plinineq[II][2]}\
\end{matrix}
\right]
\end{equation}
\begin{equation}
...
\begin{matrix}
-\frac{1}{2}\rho\p \widetilde{\sikineq[I][1]}+\frac{1}{2}\rho\p \widetilde{\sikineq[II][2]}-\frac{\vec{U}_{\max}}{2}\\
\frac{1}{2}\rho\p \widetilde{\sikineq[I][1]}-\frac{1}{2}\rho\p \widetilde{\sikineq[II][2]}-\frac{\vec{U}_{\max}}{2}
\end{matrix}
\right]
\end{equation}
...
We could do the same for the dynamics of $\lambdai$, but we let this for the author.
