...
\begin{frame}{Context}{Requirements evolve with time}
  ...
  \begin{minipage}{.5\textwidth}
    \begin{itemize}
      ...
      \item<11-> Coupled by constraints (energy)
  ...
  \begin{minipage}[c]{.45\linewidth}
    \begin{figure}[!t]
      ...
      \begin{tikzpicture}
        ...
        \draw<5>[rounded corners,red,thick] (-2.3,2.5) rectangle +(.5,-5);
        \draw<6>[rounded corners,red,thick] (2.3,2.5) rectangle +(.75,-5);
      \end{tikzpicture}
    \end{figure}
  \end{minipage}
  \hfill
...
\begin{frame}{Mitigating}
  \begin{overlayarea}{\textwidth}{.5\textwidth}
    ...
    \only<3->{``Great, But what can we do?''}
