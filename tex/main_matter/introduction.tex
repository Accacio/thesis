...
The main motivation of this work is to the securiy in a \cps{} controlled by a \dmpc{}.
Focusing on the cases where the systems are attacked by ill-intentioned agents who change some variables for their own benefit.
As we will see this attacks are called \fdi{} attacks.
