...
And a exponentially more complex system, where local demands respect only some constraints which we can use to get scarcity information by means we call \textbf{artificial scarcity}.
