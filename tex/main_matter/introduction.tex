...
\paragraph{Part~\ref{part:mpc_intro}} It serves as a gentle introduction to \dmpc{} design, security and attacks in \cps{} and the choices in this work for each one of those steps.
A reader accustomed with the theme is refered to Part~\ref{part:safe_dmpc}.
...
In Chapter~\ref{sec:anomalous} we define anomalous behaviors, give some examples, categorize them and present some methods used in the literature to prevent and combat them.

\newpage
\paragraph{Part~\ref{part:safe_dmpc}} It contains the contributions of this work.

We begin Chapter~\ref{sec:positioning} with a brief recapitulation of the choices made in each of the chapters in Part~\ref{part:mpc_intro} and we finish by a comparison of the method in this work with the most adjacent works in the literature.
