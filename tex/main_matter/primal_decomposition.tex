...
\begin{figure}[h]
  ...
  \caption{Accumulate objective functions for different values of $\tau_{3}$. \todo{remake figure, add tau in axis and change name of variables}}\label{fig:example_vary_tau_objective}
\end{figure}
