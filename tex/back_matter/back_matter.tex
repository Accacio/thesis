...
En~\cite{VelardeEtAl2017b,VelardeEtAl2018}, les auteurs présentent des méthodes robustes baséees sur la théorie des graphes, où l'attaqueur n'est pas detecté par soi, mais agents suspects sont déconnectés ou ignorés.
...
Si on substitue~\eqref{eq:example_projectedSubgradient_lambda_reprise} en~\eqref{eq:lambda_function_theta}, on a pour chaque sous-système
\begin{equation}
...
\end{equation}
Comme n'importe quel agent peut être l'attaqueur, on suppose tous les agents attaquent simultanément le système résultant en:
\begin{equation}
