...
Comme les autres travaux adjacents, nous nos intéressons par des attaques entre agents du type \textbf{\fdi{}}.
...
\begin{algorithm2e}[h]
  ...
  \Whilefr{$k\geq 0$}{
    ...
    Agents appliquent la dernière commande $\vec{u}_{i}^{\star}[0|k]$ en son sous-système respective\;
    $k\gets k+1$\;
  }
