% [[file:../../../docs/org/decomposition_methods/secureDMPC.org::onlineInsecureEstimateHFRand][onlineInsecureEstimateHFRand]]
function [coordinator, subsystems, theta, lambdaHist] = onlineInsecureEstimateHFRand(coordinator, subsystems, lambdaHist, theta, K, negotP, rho, Ac, bc, proj)
  n = subsystems.n;
  mask=triu(true(n));
  forget=0.1;
  % estHorz=n/2*(n+1)+n;
...
% onlineInsecureEstimateHFRand ends here
