...
nominal = sio.loadmat("../../data/resilient_ineq/dmpc4rooms_chSetpoint__0_selfish__0_secure__0_.mat")
selfish = sio.loadmat("../../data/resilient_ineq/dmpc4rooms_chSetpoint__0_selfish__1_secure__0_.mat")
corrected = sio.loadmat("../../data/resilient_ineq/dmpc4rooms_chSetpoint__0_selfish__1_secure__1_.mat")
...
print(np.shape(nominal_Wt))
print(latex_matrix(nominal_Wt[0]))
...
with open('../../data/resilient_ineq/references.tex', 'w') as f:
...
with open('../../data/resilient_ineq/triche_matrix_I.tex', 'w') as f:
    print(smallmatrix(corrected['T'][:,:,0]),file=f)
with open('../../data/resilient_ineq/triche_matrix_IV.tex', 'w') as f:
...
with open('../../data/resilient_ineq/reference.tex','w') as f:
    print(nominal_Wt[0][0],file=f)
with open('../../data/resilient_ineq/sampling.tex','w') as f:
    print(nominal['Te'][0][0],file=f)
with open('../../data/resilient_ineq/simulation_time.tex','w') as f:
    print(nominal['Te'][0][0]*nominal['simK'][0][0],file=f)
with open('../../data/resilient_ineq/prediction_horizon.tex','w') as f:
    print(nominal['Np'][0][0],file=f)
with open('../../data/resilient_ineq/selfish_time_I.tex','w') as f:
    print(nominal['selfish_time'][0][0],file=f)
with open('../../data/resilient_ineq/selfish_time_IV.tex','w') as f:
    print(nominal['selfish_time'][3][0],file=f)
with open('../../data/resilient_ineq/hours.tex','w') as f:
    print(nominal['Te'][0][0]*nominal['simK'][0][0],file=f)
...
with open('../../data/resilient_ineq/table_costs_all_houses_error_norm.tex', 'w') as f:
    print("I      &  $", round(100*(selfish_I-nominal_I)/nominal_I,3),               "$ & $",round(100*(corrected_I-nominal_I)/nominal_I,7),               " $\\\\",file=f)
    print("II     &  $", round(100*(selfish_II-nominal_II)/nominal_II,3),            "$ & $",round(100*(corrected_II-nominal_II)/nominal_II,7),            " $\\\\",file=f)
    print("III    &  $", round(100*(selfish_III-nominal_III)/nominal_III,3),         "$ & $",round(100*(corrected_III-nominal_III)/nominal_III,7),         " $\\\\",file=f)
    print("IV     &  $", round(100*(selfish_IV-nominal_IV)/nominal_IV,3),            "$ & $",round(100*(corrected_IV-nominal_IV)/nominal_IV,7),            " $\\\\",file=f)
    print("Global &  $", round(100*(selfish_global-nominal_global)/nominal_global,3),"$ & $",round(100*(corrected_global-nominal_global)/nominal_global,7)," $",file=f)
...
with open('../../data/resilient_ineq/table_costs_only_global.tex', 'w') as f:
