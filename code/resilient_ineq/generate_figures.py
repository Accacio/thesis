...
with open('../../data/resilient_ineq/table_costs_all_houses_error_norm.tex', 'w') as f:
    print("I      &  $", round(100*(selfish_I-nominal_I)/nominal_I,2),               "$ & $",round(100*(corrected_I-nominal_I)/nominal_I,7),               " $\\\\",file=f)
    print("II     &  $", round(100*(selfish_II-nominal_II)/nominal_II,2),            "$ & $",round(100*(corrected_II-nominal_II)/nominal_II,7),            " $\\\\",file=f)
    print("III    &  $", round(100*(selfish_III-nominal_III)/nominal_III,2),         "$ & $",round(100*(corrected_III-nominal_III)/nominal_III,7),         " $\\\\",file=f)
    print("IV     &  $", round(100*(selfish_IV-nominal_IV)/nominal_IV,2),            "$ & $",round(100*(corrected_IV-nominal_IV)/nominal_IV,7),            " $\\\\",file=f)
    print("Global &  $", round(100*(selfish_global-nominal_global)/nominal_global,2),"$ & $",round(100*(corrected_global-nominal_global)/nominal_global,7)," $",file=f)
