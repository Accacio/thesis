...
plt.savefig("../img/example_theta" +  ".png",bbox_inches='tight',facecolor=fig.get_facecolor())
...
plt.savefig("../img/example_lambda" +  ".png",bbox_inches='tight',facecolor=fig.get_facecolor())
...
plt.savefig("../img/example_state" +  ".png",bbox_inches='tight',facecolor=fig.get_facecolor())
